    ...
    flux.mobileNav = {
        ...
        _inject: function() {
            ...
            nav.innerHTML = ''
                ...
                + '    <a href="/app" data-route="Workspaces" aria-label="Home">'
                ...
                + '    <a href="/app/notifications" data-route="notifications" aria-label="Notifications">'
                + '      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">'
                ...
                + '  </li>'
                + '  <li class="flux-mobile-nav-item">'
                + '    <a href="/app/user-settings" data-route="user-settings" aria-label="Profile">'
                + '      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">'
