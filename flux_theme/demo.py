"""
Flux Theme — Demo Data
Load/clear demo data for Flux Theme showcases.
...
def load_demo_data():
    """Load demonstration data for Flux Theme.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for Flux Theme"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for Flux Theme"))
